/*
 *  To anyone who decompiles/looks at this class on GitHub: This class is not mine, it was
 *  created by Rayzr. Please be considerate when copy/pasting.
 */
...
public class JSONMessage {
	...
	private static class ReflectionHelper {
		...
		public static Object createTitlePacket(String message) {
			...
			try {
				Object packet = packetPlayOutTitle.getConstructor(titleAction, iChatBaseComponent)
		...
		public static Object createTitleTimesPacket(int fadeIn, int stay, int fadeOut) {
			...
			try {
				Object packet = packetPlayOutTitle.getConstructor(int.class, int.class, int.class).newInstance(fadeIn,
						stay, fadeOut);
				return packet;
			} catch (Exception e) {
				e.printStackTrace();
